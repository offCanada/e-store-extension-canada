...
const Settings = ({ settings, onChange }: {
    ...
    useEffect(() => {
        storageService.get<TabId>(ACTIVE_TAB_KEY).then((stored) => {
    ...
    const handleTabChange = (t: TabId) => {
        setTab(t);
        storageService.set(ACTIVE_TAB_KEY, t);
    };
                ...
                {tab === "general" && (
                    <>
                        <div class="px-4 pt-3 pb-1">
                            <p class="text-sm font-medium text-gray-400 uppercase tracking-wider mb-2.5">Settings</p>
                ...
                {tab === "display" && (
                    <>
                        ...
                        <div class="px-4 pt-2 pb-1">
                            <p class="text-sm font-medium text-gray-400 uppercase tracking-wider mb-2.5">Stores</p>
                        ...
                        {/* Banners */}
                        <div class="px-4 pt-3 pb-1">
                            <p class="text-sm font-medium text-gray-400 uppercase tracking-wider mb-2.5">Banners</p>

                            <div class="flex items-center justify-between py-1.5">
                                <div>
                                    <p class="text-md text-gray-800 m-0">Show product banner</p>
                                    <p class="text-md text-gray-400 mt-0.5">Display nutritional information on product pages</p>
                                </div>
