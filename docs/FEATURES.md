...
| Feature                    | Detail                                                                                                                                                                                                                                                |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Score badges               | **Nutri-Score** (a–e), **Eco-Score** (a+–e), **NOVA group** (1–4) and nutrient-level indicators (fat / saturated fat / sugar / sodium: low–moderate–high), shown as official SVGs. Rendered on product pages **and** inline on product listing cards. |
